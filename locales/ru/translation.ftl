...
admin-domain-register-success-local = Домен <b>{$domain}</b> добавлен пользователю (только в БД). Укажите DEFAULT_NS1 и DEFAULT_NS2 в env для регистрации через Amper в следующий раз или укажите Amper ID в списке доменов.
