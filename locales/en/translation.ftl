...
admin-domain-register-success-local = Domain <b>{$domain}</b> added for user (local only). Set DEFAULT_NS1 and DEFAULT_NS2 in env to register via Amper next time, or set Amper ID in the domain list.
